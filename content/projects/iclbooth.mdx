...
keywords: ["photo booth kiosk", "AI trading cards", "CardifyBooth", "Next.js kiosk software", "photo strip generator", "DNP printer automation", "MediaPipe hand tracking", "Gettysburg College"]
featured: true
order: 1
---
